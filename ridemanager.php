...
if (isset($_POST['submit']))
{
 ...
 $sql="insert into `ridemanagerr`(staff_id,rideid)
 values ('$staff_id','$rideid')";
...
<form method="post" autocomplete="off">
   ...
   <h2 style="color:black;"><b><u>FILL IF YOU'RE A RIDE MANAGER</u></b></h2>
               ...
               <tr>
                ...
                <td><input type="number" min=1 max=1000 placeholder="Enter your Staff ID" name="ridemanager"></td>
                  </h2>
                </tr>
                <tr>
                <td><h2 style="color:black;">ID OF THE RIDE YOU ARE MANAGING:</td>
                <td><input type="number" min="12" max="16" placeholder="Enter the ID of the Ride" name="rideid"></td>
                  </h2>
                </tr>
                <br></br>
                 <tr width="300px" align="center"><td align="center"><input type="submit" name="submit"></input></td>
