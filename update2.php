<?php
include 'connect.php';
$licenseno=$_GET['updateid'];
$sql="Select * from `driver` where licenseno='$licenseno'";
...
if (isset($_POST['submit']))
{
 ...
 $sql="update `driver` set staffid='$staffid',vehicle='$vehicle' where licenseno='$licenseno'";
 $result=mysqli_query($con,$sql);
 if ($result)
 {
...
<form method="post" autocomplete="off" >
   ...
   <br>
               ...
               <tr>
                ...
                <td><input type="number" min=1 max=1000 placeholder="Enter your Staff ID" name="driver" value="<?php echo $staffid;?>"></td>
                  </h2>
                </tr>
                <tr>
                <td><h2 style="color:black;"> TYPE OF VEHICLE:</td>
                <td><input type="text" placeholder="Enter vehicle type" name="type" value="<?php echo $vehicle;?>"></td>
                  </h2>
                </tr>
                <tr>
                    <td style="color:black;"><h2> LICENSE NUMBER:</td>
                <td><input type="text" placeholder="Enter your License number" name="lno" value="<?php echo $licenseno;?>"></td> </h2>
                </tr>
