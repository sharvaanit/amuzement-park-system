        ...
        <h2 style="color:black;"><b><u>FILL IN THE FOLLOWING IF YOU'RE NEW</u></b></h2>
                <table width="100%">
                   ...
                   <tr>
                    ...
                    <td><input type="text" required placeholder="Enter your name" name="namee"></td>
</h2>
                    </tr>
                    <tr>
                    <td><h2 style="color:black;">JOB:</td>
                    <td><input type="text" required placeholder="Enter your job" name="job"></td>
</h2>
                    </tr>
                    <tr>
                        <td><h2 style="color:black;">EXPERIENCE:</td>
                        <td><input type="number" required placeholder="Enter your experience" name="experience" min=2 max=30></td>
</h2>
                        </tr>
                        <tr>
                    ...
                    function getRndInteger(min, max) {
                      return Math.floor(Math.random() * (max - min)) + min;
                            ...
                            <tr>
                                ...
                                <td><input type="number" required min=1 max=1000 placeholder="Enter your Staff ID" name="staffid"></td>
                  </h2>
                                </tr>
